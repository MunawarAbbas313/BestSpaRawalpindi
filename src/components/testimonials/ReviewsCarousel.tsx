...
const initialReviews = [
    ...
    { name: "Ahmed Khan", text: "Certified therapists who actually know what they are doing. My back pain is gone.", rating: 5, location: "Rawalpindi", service: "Deep Tissue", date: "2024-02-10" },
    ...
    return (
        <section className="py-24 overflow-hidden relative bg-gradient-to-br from-pink-50 via-white to-pink-100">
            ...
            <div className="container px-4 md:px-6 mx-auto mb-12 relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg text-rose-700/80 max-w-2xl mx-auto mb-8">
                        Discover why locals call us the <span className="font-bold text-rose-600">Best Spa in Rawalpindi</span>.
            ...
            <div className="text-center mt-12">
                ...
                <p className="text-sm text-rose-800/60 mt-4">Join thousands of happy customers in Rawalpindi</p>
            </div>
        </section>
    );
}
