    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
                    ...
                    >
                        ...
                        <div className="p-4 bg-pink-50/50 h-64 flex flex-col gap-3 overflow-y-auto">
                            <div className="bg-white p-3 rounded-tr-2xl rounded-bl-2xl rounded-br-2xl shadow-sm text-sm text-stone-700 self-start max-w-[85%] border border-pink-100">
                                Hi there! 👋 <br />Welcome to Best Spa Rawalpindi. How can we help you relax today?
                            </div>
                        </div>
                        ...
                        <div className="p-3 bg-white border-t border-pink-100">
                            <a
                                ...
                                className="flex items-center justify-center gap-2 w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2 px-4 rounded-full transition-colors"
                            >
            ...
            <button
                ...
                className="h-14 w-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
            >
